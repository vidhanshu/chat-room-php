                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="#">
                                <h4 style="color:white;font-size:30px"><span style="font-size:40px;color:orange;">V</span>chatroom</h4>
                            </a>
                    ...
                    <div class="col-lg-8">
                        <div class="header-hero-content text-center">
                            ...
                            <h2 class="header-title wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.5s">
                                Start chatting with new peoples
                            </h2>
                            <form style="display:flex;justify-content:center;align-items:center" action="claim.php" method="post">
                                <input data-wow-duration="1.3s" data-wow-delay="1.1s" placeholder="Enter chatroom name" style="border:none;text-align:center;border-radius:10px;height:50px;transform:translateY(20px);margin:0px 10px;" type="text" name="chatroom" id="chatroom">
                                <button href="javascript:void(0)" class="main-btn wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="1.1s" type="submit">
                                    Enter to chatroom
                                </button>
                            </form>
